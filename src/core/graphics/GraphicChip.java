...
public class GraphicChip {
	...
	public static final int UPDATEFLAGADDRESS = 0x000A; // Speicheradresse des Update Flags
	public static final int VIDMEMSTART = 0xE000; // Speicheradresse wo der Videospeicher beginnt
	public static final int VIDMEMEND = 0xFFFF; // Speicheradresse wo der Videospeicher endet
	public static final int VIDMEMDARKLIGHTSTART = VIDMEMSTART;
	public static final int VIDMEMMONOCHROMCOLORSTART = 0xF000;
	public static final int PIXELWIDTH = 64; // Pixelweite des Bildes
	public static final int PIXELHEIGHT = 64; // Pixelhöhe des Bildes
	...
	public int[] getPixelAddresses(int x, int y) {
		int darkLightAddress = calculate1DAddress(x, y, PIXELWIDTH, PIXELHEIGHT, VIDMEMDARKLIGHTSTART);
		int monochromColorAddress = calculate1DAddress(x, y, PIXELWIDTH, PIXELHEIGHT, VIDMEMMONOCHROMCOLORSTART);
	...
	public byte[] getVideoMemory() {
    	return retro24.readMemory(VIDMEMSTART, VIDMEMEND);
    }
	...
	public void loadRandomTestImage() {
		Random r = new Random();
		for (int i = VIDMEMSTART; i < VIDMEMEND; i++) {
	...
	public void loadRetro24WelcomeScreen() {
		...
		for (int[] coord : yellowCoordinates) {
			setVidMemPixel(coord, true, true);
		}
		
		for (int[] coord : whiteCoordinates) {
			setVidMemPixel(coord, true, false);
		}
		
		for (int[] coord : blueCoordinates) {
			setVidMemPixel(coord, false, true);
		}
	}
	...
	public boolean getUpdateFlag() {
		return retro24.readMemory(UPDATEFLAGADDRESS) == 0x01;
	}
	...
	public void setUpdateFlag(boolean flag) {
		...
		retro24.writeMemory(UPDATEFLAGADDRESS, byteFlag);
	}
